        ...
        <div style={{display:'flex'}}>
            {store.student.isAuthenticated ? <>
                ...
                <div className="container mt-3" style={{padding:'20px'}} >
                    <p style={{padding:'7px 20px', fontSize:30, background:'#a9a9a9', color:'white', textAlign:'center'}} > Chat With Friend </p>
                    
                    <div className="row" style={{padding:'20px 50px' , display:'flex', flexDirection:'column'}}>
...
{console.log(store.student.privateChat.map(({message}) => message))}
{/* {console.log([...new Set(store.student.privateChat).map(({message}) => message)])} */}
                        </div>
