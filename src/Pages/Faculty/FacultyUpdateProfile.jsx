...
const FacultyUpdateProfile = () => {
    ...
    const formHandler = async (e) => {
        ...
        formData.append("NIDCard", aadharCard)
    ...
    return (
        <div style={{display:'flex'}}>
            {store.faculty.isAuthenticated ? <>
                ...
                <p style={{padding:'7px 20px', fontSize:30, background:'#a9a9a9', color:'white', textAlign:'center'}} > Update Profile </p>
                    <div className="row ">
                        <div className="col-md-10 w-100 m-auto">
