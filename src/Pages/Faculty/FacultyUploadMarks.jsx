...
import { fetchStudentsForMarks, uploadMarks } from '../../redux/action/facultyAction'
...
const FacultyUploadMarks = () => {
    ...
    const formHandler = (e) => {
       ...
       dispatch(fetchStudentsForMarks(department, year,  section))
    ...
    return (
        <div style={{display:'flex'}}>
            {store.faculty.isAuthenticated ? <>
                ...
                <p style={{padding:'7px 20px', fontSize:30, background:'#a9a9a9', color:'white', textAlign:'center'}} > Upload Marks </p>
                ...
                {store.faculty.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                    <div className="col-md-10">
                        <form noValidate onSubmit={formHandler}>
                            ...
                            <button type="submit" id='btn' className="btn btn-primary">Search</button>
                        </form>
                    </div>
                        ...
                        <form onSubmit={secondFormHandler}>
                            ...
                            <div className="form-group">
                                ...
                                <select onChange={(e) => setExam(e.target.value)} value={exam} className={classnames("form-control",
                                    ...
                                    <option>Select</option>
                                    <option value="CycleTest1">Class Test</option>
                                    <option value="CycleTest2">Mid</option>
                                        ...
                                        store.faculty.fetchedStudents.map((obj, index) =>
                                            <tr key={index}>
                                                ...
                                                <td><div className="form-check">
                                                    <input className="form-control" style={{width:'100px'}}  required type="number" value={obj.marks} onChange={(e) => handleInputChange(e.target.value, obj._id)} id="defaultCheck1" />
                                                </div></td>
                                            </tr>
                                        )
                                    }
                            ...
                            <button type="submit" id='btn' className="btn btn-primary ml-1">Submit</button>
                        </form>
                    </div>
                </div>
                }
