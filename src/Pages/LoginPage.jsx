...
const LoginPage = () => {
    ...
    const [registrationNumber, setRegistrationNumber] = useState('ADM202102000')
    const [password, setPassword] = useState('04-10-1998')
            ...
            <div className="row justify-content-center">
                <div className="col-md-8">
                    <div className="d-flex justify-content-md-center align-items-center vh-100">
                        <div style={{padding:'45px 55px 65px' , border:'1px solid #17a2b8' , borderRadius:15}} >
                            <h1 className="display-4 text-center" style={{color:'#17a2b8' ,marginBottom:60}} >ADMIN</h1>
