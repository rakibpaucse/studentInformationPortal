...
const AdminGetAllFaculty = () => {
    ...
    useEffect(() => { setIsLoading(false)}, [store.admin.allStudent])
    ...
    return (
        <div style={{display:'flex'}}>
            {store.admin.isAuthenticated ? <>
                ...
                <p style={{padding:'7px 20px', fontSize:30, background:'#a9a9a9', color:'white', textAlign:'center'}} >  Get All Students </p>
