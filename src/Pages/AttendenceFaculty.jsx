    ...
    return (
        <div style={{display:'flex'}}>
            {store.faculty.isAuthenticated ? <>
                ...
                <p style={{padding:'7px 20px', fontSize:30, background:'#a9a9a9', color:'white', textAlign:'center'}} > Make Attendence </p>
                ...
                {store.faculty.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                    <div className="col-md-10">
                        <form noValidate onSubmit={formHandler}>
                            ...
                            {!isLoading && <button type="submit" id='btn' className="btn btn-info  ">Search</button>}
                        </form>
                    </div>
                </div>}
                ...
                {!store.faculty.fetchedStudentsHelper && <div className="row  justify-content-center mt-4">
                    <div className="col-md-10">
                        <form onSubmit={secondFormHandler}>
                            ...
                            {!isLoading2 && <button type="submit" id='btn' className="btn btn-info ml-1  ">Submit</button>}
                        </form>
                    </div>
                </div>
                }</div></> : (history.push('/'))}
